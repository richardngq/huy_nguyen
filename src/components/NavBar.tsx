...
export const Navbar: FC = () => {
  ...
  return (
    <div className='fixed top-0 left-0 right-0 bg-[rgba(255,255,255,0.95)] backdrop-blur-lg inline-flex p-3 lg:p-6 z-[999]' data-aos="fade-in" style={{ boxShadow: `0px -1px 8px rgba(0,0,0,0.05)` }}>
      <Link href={'/'}>
        <Image src={Logo} alt="" />
      </Link>

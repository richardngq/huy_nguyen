...
export const Navbar: FC = () => {
  ...
  return (
    <div className='fixed top-2 inset-x-2 bg-black/10 border border-white/10 backdrop-blur-xl rounded inline-flex gap-2 lg:gap-8 py-2 px-6 lg:p-6 lg:px-8 z-[999]' data-aos="fade" data-aos-delay={1000} style={{ boxShadow: `0px -1px 8px rgba(0,0,0,0.05)` }}>
      <Link href={'/'}>

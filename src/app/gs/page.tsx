        ...
        <div className="container mx-auto">
          ...
          <div className='text-base opacity-75 mt-8 group'>
            ...
            <ul className='text-base mt-4 ms-4 list-disc list-outside'>
              <li className='group-hover:bg-lime-400 opacity-75 group-hover:opacity-100 w-fit'>Understand the user&rsquo;s goals and needs.</li>
              <li className='group-hover:bg-lime-400 opacity-75 group-hover:opacity-100 w-fit mt-1'>Identify weaknesses within the current user journey.</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto">
          ...
          <div className='flex flex-col lg:flex-row gap-6 mt-4'>
            <div className="w-full group">
              ...
              <p className='opacity-75 text-sm mt-4 group-hover:bg-lime-400'><b>Farfetch:</b> Requires users to confirm information and the recipient&rsquo;s address during checkout, even if they have logged in and confirmed the billing address previously.</p>
            </div>
            <div className="w-full group">
              <div className='w-full h-fit border-4 border-white rounded-2xl overflow-hidden shadow-[0px_6px_6px_rgba(0,0,0,0.1)]'>
                <Image src={imageURL3b} alt="" className='w-full' />
              </div>
              <p className='opacity-75 text-sm mt-4 group-hover:bg-lime-400'><b>Pacsun:</b> Does not provide e-payment services and remains loyal to the charge by card system.</p>
            </div>
            <div className="hidden lg:block w-full" />
          </div>
          <p className='text-base opacity-75 mt-8'>
      ...
      <div className="result py-10" data-aos="fade-up">
        <div className="container mx-auto">
          ...
          <p className='text-base opacity-75 mt-4 group'>
            Customer feedback has been very positive. This marks our first step on the Trustpilot rating system. Particularly noteworthy is the feedback from older customers who share, &ldquo;<i className="group-hover:bg-lime-400">Now we won&rsquo;t need assistance to check and edit troublesome payment details anymore</i>&rdquo;
          </p>

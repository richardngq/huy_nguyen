...
export default function About() {
  ...
  const dataExp = [
    {
      ...
      Descriptions: [
        ...
        ` - Led end-to-end design and product strategy for Agentic AI and Automation Workflow platform, driving adoption through refined user experience and intuitive workflow orchestration.`,
        ` - Architected design system and interaction patterns for AI-powered automation tools, enabling seamless integration of complex agentic behaviors into user-friendly interfaces.`
      ],
    },
    {
  ...
  return (
    <section className="container mt-20 mx-auto lg:pt-10">
      <div className="profile lg:self-start lg:z-20 flex flex-col lg:flex-row items-start lg:items-start gap-6 lg:gap-8">

        <div id="avatar-img" className="aspect-square w-2/3 md:w-32 lg:w-64 lg:sticky top-32 overflow-hidden">
        ...
        <div className="spacing-y-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="text-base font-thin">
              As a <b>Product Designer</b> and
              <b>Product Owner</b>
              {/* <br className="flex md:hidden" /> a <b>FE Developer</b>  */}
              with <i>7+ years of experience</i>.
              <br />
              ...
              <div className="inline-flex items-center flex-wrap gap-2">
                {
                  dataDomains.map((item, index) => (
                    <motion.div
                      key={index}
                      className="bg-white/10 text-white/75 backdrop-blur-sm text-sm px-3 py-0.5 filter-blur rounded-full hover:bg-white/20 hover:text-white transition-all"
